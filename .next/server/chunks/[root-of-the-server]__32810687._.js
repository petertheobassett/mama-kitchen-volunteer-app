...
"[project]/.next-internal/server/app/api/confirm-to-event/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/confirm-to-event/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    // ✅ Robust date parser (handles ISO string or serial number)
    const toISODate = (val)=>{
        if (!val) return '';
        if (!isNaN(val)) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__32810687._.js.map