...
"[project]/src/lib/parseGoogleDate.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$parseGoogleDate$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/parseGoogleDate.js [app-route] (ecmascript)");
;
;
async function GET() {
    try {
        ...
        const toISODate = (val)=>{
            if (!val) return '';
            if (!isNaN(val)) {
                const date = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$parseGoogleDate$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseGoogleSerialDate"])(Number(val));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d19cf1fc._.js.map