...
"[project]/.next-internal/server/app/api/get-events/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/get-events/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const events = rows.map(([rawDate, name])=>{
            ...
            const parsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$parseGoogleSerialDate$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseGoogleSerialDate"])(serial);
            return {
                name: name?.trim() || '',
                date: parsed.toISOString().slice(0, 10),
                label: `${parsed.toDateString()} – ${name}`
            };
        }).filter(Boolean);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4c507b90._.js.map