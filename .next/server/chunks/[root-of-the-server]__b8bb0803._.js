...
"[project]/.next-internal/server/app/api/signups-overview/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/lib/parseGoogleSerialDate.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "parseGoogleSerialDate": (()=>parseGoogleSerialDate)
});
...
"[project]/src/app/api/signups-overview/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$parseGoogleSerialDate$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/parseGoogleSerialDate.js [app-route] (ecmascript)");
;
;
async function GET() {
    try {
        ...
        const toISODate = (val)=>{
            if (!val) return '';
            if (!isNaN(val)) {
                const date = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$parseGoogleSerialDate$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseGoogleSerialDate"])(Number(val));
        ...
        const enriched = signups.map(([timestamp, eventName, eventDate, name, phone, email])=>{
            ...
            const needsDirectoryUpdate = isInDirectory && (currentPhone !== phone.trim() || currentEmail !== email.trim());
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b8bb0803._.js.map